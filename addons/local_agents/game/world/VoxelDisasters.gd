...
const TornadoScript: GDScript = preload("res://addons/local_agents/sim/actors/Tornado.gd")
const ThunderstormScript: GDScript = preload("res://addons/local_agents/sim/actors/Thunderstorm.gd")
const HurricaneScript: GDScript = preload("res://addons/local_agents/sim/actors/Hurricane.gd")
...
## (the cell seeds the ingredients only; it never spawns a bolt itself).
