...
layout(set = 0, binding = 4, std430) restrict buffer VelY { float vel_y[]; };   // outward-radial, m/s
...
// lateral slot N_LAT0+l neighbour in this cell's own (tan_a, tan_b) axes.
...
void main() {
	...
	// BUOYANCY (radial-up wind): a column steeper than the dry adiabat is unstable and overturns.
