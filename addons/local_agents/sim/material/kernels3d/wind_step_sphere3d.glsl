...
// structurally identical. Box idx±offset → INDEX TABLE nbr[idx*6 + d] (slots: neighbours.glsli,
...
void main() {
	...
	// BUOYANCY (radial-up wind): a hot cell under a cooler open cell rises. Uses the OUTWARD neighbour
