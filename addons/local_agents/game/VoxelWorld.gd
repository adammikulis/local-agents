...
const LlmServiceScript: GDScript = preload("res://addons/local_agents/agents/LlmService.gd")
const VegetationRendererScript: GDScript = preload("res://addons/local_agents/sim/mesh/VegetationRenderer.gd")
const HudScript: GDScript = preload("res://addons/local_agents/game/ui/SpawnPaletteHud.gd")
const AudioDirectorScript: GDScript = preload("res://addons/local_agents/audio/AudioDirector.gd")
const InteractionScript: GDScript = preload("res://addons/local_agents/game/world/VoxelInteraction.gd")
...
const WaterParticlesScript: GDScript = preload("res://addons/local_agents/sim/material/WaterParticles.gd")
const WaterSurfaceScript: GDScript = preload("res://addons/local_agents/sim/material/MaterialFieldRender3D.gd")
const DrainageOverlayScript: GDScript = preload("res://addons/local_agents/game/ui/DrainageOverlay.gd")
const BiomeShaderScript: GDScript = preload("res://addons/local_agents/game/world/BiomeShaderController.gd")
const SeaIceShaderScript: GDScript = preload("res://addons/local_agents/game/world/SeaIceShaderController.gd")
const StreamerHostScript: GDScript = preload("res://addons/local_agents/sim/streamer/StreamerHost.gd")
const ThoughtPanelScript: GDScript = preload("res://addons/local_agents/game/ui/CreatureThoughtPanel.gd")
const EventTrackerScript: GDScript = preload("res://addons/local_agents/sim/events/LAEventTracker.gd")
const PlanetBodyScript: GDScript = preload("res://addons/local_agents/sim/system/PlanetBody.gd")
...
const SkyControllerScript: GDScript = preload("res://addons/local_agents/game/world/VoxelSkyController.gd")
const SpawnControllerScript: GDScript = preload("res://addons/local_agents/game/world/VoxelSpawnController.gd")
const InputControllerScript: GDScript = preload("res://addons/local_agents/game/world/VoxelInputController.gd")
const DebugWiringScript: GDScript = preload("res://addons/local_agents/game/world/VoxelDebugWiring.gd")
const AudioControllerScript: GDScript = preload("res://addons/local_agents/game/world/VoxelAudioController.gd")
