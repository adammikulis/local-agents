...
// LASphereGrid.link_tan: ((cell/depth)*4 + l)*2 is the unit direction toward the lateral slot l neighbour,
// in that cell's own (tan_a, tan_b) axes.
...
void main() {
	...
	// no air carries the weight of the air standing over it, which is what heat3d_solar reads. ---
	float above = 0.0;
