...
@export var flow_with_speed_bonus: float = 0.12
@export var flow_against_speed_penalty: float = 0.3
@export var cross_flow_speed_penalty: float = 0.08
...
@export var flow_efficiency_bonus: float = 0.06
@export var flow_efficiency_penalty: float = 0.14
...
func to_dict() -> Dictionary:
    return {
        ...
        "flow_with_speed_bonus": flow_with_speed_bonus,
        "flow_against_speed_penalty": flow_against_speed_penalty,
        "cross_flow_speed_penalty": cross_flow_speed_penalty,
        ...
        "flow_efficiency_bonus": flow_efficiency_bonus,
        "flow_efficiency_penalty": flow_efficiency_penalty,
...
func from_dict(values: Dictionary) -> void:
    ...
    flow_with_speed_bonus = clampf(float(values.get("flow_with_speed_bonus", flow_with_speed_bonus)), 0.0, 2.0)
    flow_against_speed_penalty = clampf(float(values.get("flow_against_speed_penalty", flow_against_speed_penalty)), 0.0, 2.0)
    cross_flow_speed_penalty = clampf(float(values.get("cross_flow_speed_penalty", cross_flow_speed_penalty)), 0.0, 2.0)
    ...
    flow_efficiency_bonus = clampf(float(values.get("flow_efficiency_bonus", flow_efficiency_bonus)), 0.0, 1.0)
    flow_efficiency_penalty = clampf(float(values.get("flow_efficiency_penalty", flow_efficiency_penalty)), 0.0, 1.0)
