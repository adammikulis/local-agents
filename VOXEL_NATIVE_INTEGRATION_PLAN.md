...
- Convert this finalized plan into an execution checklist in `ARCHITECTURE_PLAN.md` Concern I with concrete task checkboxes and begin Phase 1 implementation.
