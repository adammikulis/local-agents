...
const _CAMERA_MODE_LABEL := "Mode: Camera"
const _FPS_MODE_LABEL := "Mode: FPS"
...
func configure(
	...
	handle_camera_button_fn: Callable,	is_input_enabled: bool = true
) -> void:
	_host = host
...
func _handle_key_input(key_event: InputEventKey) -> void:
	...
	if key_event.keycode == KEY_SPACE:
		if _is_fps_mode and not _spawn_mode_active():
			_fire_if_possible()
		return
